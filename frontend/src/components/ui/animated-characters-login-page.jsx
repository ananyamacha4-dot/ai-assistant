...
export default function AnimatedLoginPage({ onLogin, onSignup, onGoogleLogin, authError }) {
          ...
          <div className="relative" style={{ width: "550px", height: "400px" }}>
            ...
            <div
              ...
              style={{
                ...
                transform: pwVisible ? "skewX(0deg)"
                  : (isTyping || pwHidden) ? `skewX(${(purplePos.bodySkew || 0) - 12}deg) translateX(40px)`
            ...
            <div
              ...
              style={{
                ...
                transform: pwVisible ? "skewX(0deg)"
                  ...
                  : (isTyping || pwHidden) ? `skewX(${(blackPos.bodySkew || 0) * 1.5}deg)`
        ...
        <div className="w-full max-w-[420px]">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <Button type="submit" className="w-full h-12 text-base font-medium" size="lg" disabled={isLoading}>
              {isLoading ? (isSignupMode ? "Creating account..." : "Signing in...") : (isSignupMode ? "Sign Up" : "Log in")}
            </Button>
          </form>
